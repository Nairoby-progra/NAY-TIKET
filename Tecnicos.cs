...
public Tecnico(string strCodigo, string strNombre, string strCorreo, string
strEspecialidad, int intCapacidadMaxima)
...
(strEspecialidad.Equals(strCategoria,
StringComparison.OrdinalIgnoreCase) ||
strEspecialidad.Equals("General",
StringComparison.OrdinalIgnoreCase));
}
...
Console.WriteLine($" Especialidad: {strEspecialidad} | Carga:
{intCargaActual}/{intCapacidadMaxima}");
}
}
}
